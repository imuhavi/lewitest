...
<body>
  <header class="site-header" id="header">
    <h1 class="site_header__title" data-lead-id="site-header-title">Shop is Active!</h1>
  </header>
  <div class="main-content">
    <i class="fa fa-check main-content__checkmark" id="checkmark"></i>
    <p class="main-content__body" data-lead-id="main-content-body">Your Shop is active now.You can sign in with your
      credintail. Thank you!</p>
  </div>
