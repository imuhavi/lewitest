                                  ...
                                  <tbody>
                                    @foreach ( $data as $subcatItem )
                                       <tr>
                                           ...
                                           <td>
                                             <span
                                                 class="badge badge-pill badge-{{ $subcatItem->status === 'Active' ? 'success' : 'danger' }}">{{ $subcatItem->status }}</span>
                                           </td>
                                           <td>
                                               <a class="btn btn-sm btn-info"
                                                   href="{{ url( routePrefix() . '/subcategory/' . $subcatItem->id . '/edit') }}"><i class="fa fa-edit"></i></a>

                                               <a class="btn btn-sm btn-info"
                                                   href="{{ url( routePrefix() . '/subcategory/' . $subcatItem->id) }}"><i class="fa fa-eye"></i></a>
                                               <form style="display: inline-block"
                                                   action="{{ route('subcategory.destroy', $subcatItem->id) }}"
                                                   method="post">
                                                   @csrf
                                                   @method('DELETE')
            ...
            @elseif ( $page == 'create' || $page == 'edit')
              <div class="col-md-6 col-md-offset-3">
                  <div class="panel panel-white">
                      ...
                      <div class="panel-body">
                          <form action="{{ $page == 'create' ? url(routePrefix().'/subcategory') : url(routePrefix(). '/subcategory/'. $data->id ) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @if($page == 'edit')
                              @method('PATCH')
                            @endif
                                      ...
                                      <select name="category_id" id="category" class="form-control">
                                          ...
                                          @foreach ( $category as $cat_item )
                                            <option value="{{ $cat_item->id }}"
                                              @if ( $page == 'edit') {{ $cat_item->id == $data->id ? 'selected' : '' }} @endif
