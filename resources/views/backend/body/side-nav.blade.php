<div class="page-sidebar sidebar">
    <div class="page-sidebar-inner slimscroll">
        <ul class="menu accordion-menu">
            ...
            <li><a href="profile.html" class="waves-effect waves-button"><span class="menu-icon icon-user"></span>
                    <p>Profile</p>
                </a></li>
            ...
            <li class="droplink"><a href="#" class="waves-effect waves-button"><span
                        class="menu-icon icon-puzzle"></span>
                    <p>UI Kits</p><span class="arrow"></span>
                </a>
                <ul class="sub-menu">
            ...
            <li class="droplink"><a href="#" class="waves-effect waves-button"><span
                        class="menu-icon icon-layers"></span>
                    <p>Layouts</p><span class="arrow"></span>
                </a>
                <ul class="sub-menu">
            ...
            <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-grid"></span>
            ...
            <li class="droplink"><a href="#" class="waves-effect waves-button"><span
                        class="menu-icon icon-pie-chart"></span>
