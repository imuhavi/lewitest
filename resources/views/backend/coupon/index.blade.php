            ...
            <form action="#" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control m-t-xxs" id="coupon_name" name="code"
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="date" name="end" class="form-control" id="end_date" placeholder="Ex: New Year 2021">
                </div>
              </div>
              ...
              <div class="form-row">
                <div class="form-group">
                  ...
                  <input type="number" name="discount" class="form-control" placeholder="Ex: 300">
                </div>
              </div>
